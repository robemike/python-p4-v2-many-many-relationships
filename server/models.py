...
# Association/ Join table to store the many-many relationship between the employees and the meetings.
...
class Meeting(db.Model):
    ...
    # Add a relationship between the meetings and the employees table.
    # Secondary parameter is included to show that relationship is via a secondary table.
